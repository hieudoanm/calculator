import { base } from '@numbers/utils/base';
...
const HomePage: NextPage = () => {
  ...
  return (
    <div className="flex h-screen w-screen items-center justify-center">
      <div className="flex w-full max-w-sm flex-col gap-y-2 divide-y divide-neutral-200 rounded border border-neutral-200 shadow-sm">
        {[
